...
void main() {
  group('B.2 — 30 ô của bảng mức độ liên quan', () {
    test('S1 × individual = Cần', () {
      expect(
        relevanceOf(ScaDimension.s1, SeniorityTier.individual),
        SkillRelevance.needed,
      );
    });
    test('S1 × leadTeam = Cần', () {
      expect(
        relevanceOf(ScaDimension.s1, SeniorityTier.leadTeam),
        SkillRelevance.needed,
      );
    });
    test('S1 × leadOrg = Cần', () {
      expect(
        relevanceOf(ScaDimension.s1, SeniorityTier.leadOrg),
        SkillRelevance.needed,
      );
    });
    test('S2 × individual = Cần', () {
      expect(
        relevanceOf(ScaDimension.s2, SeniorityTier.individual),
        SkillRelevance.needed,
      );
    });
    test('S2 × leadTeam = Cần', () {
      expect(
        relevanceOf(ScaDimension.s2, SeniorityTier.leadTeam),
        SkillRelevance.needed,
      );
    });
    test('S2 × leadOrg = Cần', () {
      expect(
        relevanceOf(ScaDimension.s2, SeniorityTier.leadOrg),
        SkillRelevance.needed,
      );
    });
    test('S3 × individual = Nên có', () {
      expect(
        relevanceOf(ScaDimension.s3, SeniorityTier.individual),
        SkillRelevance.nice,
      );
    });
    test('S3 × leadTeam = Cần', () {
      expect(
        relevanceOf(ScaDimension.s3, SeniorityTier.leadTeam),
        SkillRelevance.needed,
      );
    });
    test('S3 × leadOrg = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.s3, SeniorityTier.leadOrg),
    ...
    test('C1 × leadOrg = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.c1, SeniorityTier.leadOrg),
        SkillRelevance.critical,
      );
    });
    test('C2 × individual = Cần', () {
      expect(
        relevanceOf(ScaDimension.c2, SeniorityTier.individual),
        SkillRelevance.needed,
      );
    });
    test('C2 × leadTeam = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.c2, SeniorityTier.leadTeam),
        SkillRelevance.critical,
      );
    });
    test('C2 × leadOrg = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.c2, SeniorityTier.leadOrg),
        SkillRelevance.critical,
      );
    });
    test('C3 × individual = Nên có', () {
      expect(
        relevanceOf(ScaDimension.c3, SeniorityTier.individual),
        SkillRelevance.nice,
      );
    });
    test('C3 × leadTeam = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.c3, SeniorityTier.leadTeam),
        SkillRelevance.critical,
      );
    });
    test('C3 × leadOrg = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.c3, SeniorityTier.leadOrg),
        SkillRelevance.critical,
      );
    });
    ...
    test('A2 × individual = Cần', () {
      expect(
        relevanceOf(ScaDimension.a2, SeniorityTier.individual),
        SkillRelevance.needed,
      );
    });
    test('A2 × leadTeam = Cần', () {
      expect(
        relevanceOf(ScaDimension.a2, SeniorityTier.leadTeam),
        SkillRelevance.needed,
      );
    });
    test('A2 × leadOrg = Cần', () {
      expect(
        relevanceOf(ScaDimension.a2, SeniorityTier.leadOrg),
        SkillRelevance.needed,
      );
    });
    test('A3 × individual = Nên có', () {
      expect(
        relevanceOf(ScaDimension.a3, SeniorityTier.individual),
        SkillRelevance.nice,
      );
    });
    test('A3 × leadTeam = Cần', () {
      expect(
        relevanceOf(ScaDimension.a3, SeniorityTier.leadTeam),
        SkillRelevance.needed,
      );
    });
    test('A3 × leadOrg = Cần, ưu tiên cao', () {
      expect(
        relevanceOf(ScaDimension.a3, SeniorityTier.leadOrg),
        SkillRelevance.critical,
      );
    });
    test('A4 × individual = Nên có', () {
      expect(
        relevanceOf(ScaDimension.a4, SeniorityTier.individual),
        SkillRelevance.nice,
      );
    });
    test('A4 × leadTeam = Nên có', () {
      expect(
        relevanceOf(ScaDimension.a4, SeniorityTier.leadTeam),
        SkillRelevance.nice,
      );
    });
    test('A4 × leadOrg = Cần', () {
      expect(
        relevanceOf(ScaDimension.a4, SeniorityTier.leadOrg),
        SkillRelevance.needed,
      );
    });
  });
