...
void main() {
  ...
  group('computeStreak', () {
    ...
    test(
      'streak ending yesterday counts (streak not broken until a full day missed)',
      () {
    ...
    test(
      'streak starting from yesterday breaks if day before yesterday missing',
      () {
        // only yesterday = 1
        expect(
          computeStreak([DateTime(2026, 7, 16)], DateTime(2026, 7, 17)),
          1,
        );
      },
    );
    ...
    test(
      'time components within a day are ignored (checkins with different times on same day)',
      () {
