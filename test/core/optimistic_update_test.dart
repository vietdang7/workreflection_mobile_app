...
class _FailingCheckinRepo implements WrRepository {
  ...
  @override
  Future<Checkin?> getTodayCheckin() => _d.getTodayCheckin();
  @override
  ...
  Future<List<DateTime>> getCheckinDates({int limit = 60}) =>
      _d.getCheckinDates(limit: limit);
  @override
  Future<int> countCheckins() => _d.countCheckins();
  @override
  Future<Insight?> getLatestInsight() => _d.getLatestInsight();
  @override
  Future<List<Insight>> getInsights() => _d.getInsights();
  @override
  Future<int> countInsights() => _d.countInsights();
  @override
  Future<List<RecurringSituation>> getRecurringSituations() =>
      _d.getRecurringSituations();
  @override
  Future<DevelopmentTheme?> getActiveTheme() => _d.getActiveTheme();
  @override
  Future<List<Practice>> getTodayPractices() => _d.getTodayPractices();
  @override
  Future<void> updatePracticeStatus(String id, PracticeStatus s) =>
      _d.updatePracticeStatus(id, s);
  @override
  Future<List<TimelineEvent>> getTimelineEvents() => _d.getTimelineEvents();
  @override
  Future<int> countMilestones() => _d.countMilestones();
  @override
  Future<MobileProfile?> getMobileProfile() => _d.getMobileProfile();
  @override
  Future<void> updateReminder(bool e) => _d.updateReminder(e);
  @override
  Future<void> updateLanguage(String l) => _d.updateLanguage(l);
  @override
  Future<void> saveCareerSnapshot(CareerSnapshot s) => _d.saveCareerSnapshot(s);
  @override
  Future<void> saveRecentSituationIds(List<String> c) =>
      _d.saveRecentSituationIds(c);
  @override
  Future<void> saveRoleText(String? r) => _d.saveRoleText(r);
  @override
  Future<void> saveMyInfo(Map<String, String?> f) => _d.saveMyInfo(f);
  @override
  Future<String> uploadContextDocument(List<int> b, String e, String d) =>
      _d.uploadContextDocument(b, e, d);
  @override
  Future<ScaReport?> getLatestScaReport() => _d.getLatestScaReport();
  @override
  Future<Workshop?> getUpcomingWorkshop() => _d.getUpcomingWorkshop();
  @override
  Future<Map<String, dynamic>> getCcProfile() => _d.getCcProfile();
  @override
  Future<List<WrPremiumPricing>> getPremiumPlans() => _d.getPremiumPlans();
  @override
  Future<void> updateCcProfile(Map<String, dynamic> fields) =>
      _d.updateCcProfile(fields);
  @override
  Future<void> updateDisplayName(String displayName) =>
      _d.updateDisplayName(displayName);
  @override
  Future<Map<String, dynamic>> exportUserData() => _d.exportUserData();
  @override
  Future<void> ensureSeeded({String? onboardingSituation}) =>
      _d.ensureSeeded(onboardingSituation: onboardingSituation);
  @override
  Future<void> saveOnboardingSituation(String s) =>
      _d.saveOnboardingSituation(s);
  @override
  Future<String> uploadAvatar(List<int> bytes, String ext) =>
      _d.uploadAvatar(bytes, ext);
  @override
  Future<List<Map<String, dynamic>>> getVouchers() => _d.getVouchers();
  @override
  Future<List<Map<String, dynamic>>> getInvitations() => _d.getInvitations();
  @override
  Future<String> acceptInvitation(String token) => _d.acceptInvitation(token);
  @override
  Future<void> declineInvitation(String invitationId) =>
      _d.declineInvitation(invitationId);
}
...
class _FailingPracticeRepo implements WrRepository {
  ...
  Future<void> upsertCheckin(
    ...
    CheckinEnergy? energy,
    CheckinDirection? direction,
  }) => _d.upsertCheckin(mood, energy: energy, direction: direction);
  @override
  Future<List<DateTime>> getCheckinDates({int limit = 60}) =>
      _d.getCheckinDates(limit: limit);
  @override
  ...
  Future<List<Practice>> getTodayPractices() => _d.getTodayPractices();
  @override
  Future<void> updatePracticeStatus(String id, PracticeStatus s) async =>
...
void main() {
  group(
    'CheckinNotifier — optimistic update reverts to prior state on failure',
    () {
      ...
      test(
        'reverts to happy when prior mood was happy and upsert throws',
        () async {
  ...
  group(
    'PracticesNotifier — optimistic update reverts to prior state on failure',
    () {
      test('reverts to todo when updatePracticeStatus throws', () async {
        ...
        expect(
          state.valueOrNull?.first.status,
          PracticeStatus.todo,
  ...
  group('FakeSurveyRepository — blocker contracts', () {
    test(
      'B1+B2: getActionProgress ignores reportId (no param), toggleTask works',
      () async {
    ...
    test(
      'B3: getActionPlan returns all phases ordered by day regardless of type',
      () async {
        final fake = FakeSurveyRepository();
        fake.seedActionPlan([
          ActionPlanPhase(
    ...
    test(
      'B4: getQuestions with config preserves order and filters is_active',
      () async {
        final fake = FakeSurveyRepository();
        final q1 = CcQuestion(
          id: 'q1',
  ...
  group('FakeSurveyRepository — idempotent cc_reports (Fix 3)', () {
    test(
      'calling submitSurvey twice with same existingSurveyId returns same report, no duplicate',
      () async {
        final fake = FakeSurveyRepository();
        ...
        expect(
          ...
          equals(report1.id),
          reason:
              'second call with same surveyId must return existing report id',
        );
        expect(
          fake.submitSurveyCalls,
          hasLength(2),
  ...
  group('ActionProgressNotifier — rollback', () {
    test(
      'N18: optimistic toggle rolls back to prior value on failure',
      () async {
        final fake = FakeSurveyRepository();
        fake.seedActionProgress({'t1': false});

        final container = ProviderContainer(
          overrides: [surveyRepositoryProvider.overrideWithValue(fake)],
        );
        addTearDown(container.dispose);

        final notifier = container.read(
          actionProgressNotifierProvider('r1').notifier,
        );
        notifier.init({'t1': false});
        expect(
          container.read(actionProgressNotifierProvider('r1'))['t1'],
          isFalse,
        );
