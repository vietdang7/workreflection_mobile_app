...
void main() {
  ...
  group('ReportPdfBuilder', () {
    ...
    ReportPdfData premiumData({String locale = 'vi'}) =>
        freeData(locale: locale).copyWith(scoreEsi: 3.9, scoreEnps: 7);
    ...
    test(
      'build handles Vietnamese diacritics in user name without throwing',
      () async {
