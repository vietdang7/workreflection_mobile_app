...
final videoReportDataProvider = FutureProvider.family<VideoReportData, String>((
  ref,
  reportId,
) async {
  ...
  final surveyType = (report.subScores != null && report.subScores!.isNotEmpty)
      ? SurveyType.premium
      : SurveyType.free;
  ...
  raw ??= await repo.createAndWait(
    ...
    narrationScript: {
      ...
      'scenes': scenes.map((s) => {'id': s.id.name, 'text': s.text}).toList(),
    },
    language: locale,
  );
