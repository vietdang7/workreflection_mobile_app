...
const Map<ExperienceState, Set<ExperienceState>> _allowedTransitions = {
  ExperienceState.emerging: {ExperienceState.captured},
  ...
  ExperienceState.committed: {ExperienceState.integrated},
  ExperienceState.integrated: {
    ExperienceState.dormant,
    ExperienceState.reactivated,
  },
  ExperienceState.dormant: {ExperienceState.reactivated},
  // Reactivated luôn quay về Exploring (WXS §4.3 State 9).
  ExperienceState.reactivated: {ExperienceState.exploring},
};
...
Map<ReflectionPattern, String> get _defaultPrompts => {
  ReflectionPattern.notice: tr(
    'Điều gì đang chiếm nhiều năng lượng của bạn nhất lúc này?',
    'What is taking the most out of you right now?',
  ),
  ReflectionPattern.name: tr(
    'Nếu gọi tên điều bạn đang trải qua bằng một câu, bạn sẽ nói gì?',
    'If you named what you are going through in one line, what would it be?',
  ),
  ReflectionPattern.explore: tr(
    'Tình huống này làm bạn nhớ đến điều gì?',
    'What does this situation remind you of?',
  ),
  ReflectionPattern.reframe: tr(
    'Nếu một người bạn kể lại chuyện này, bạn sẽ nói gì với họ?',
    'If a friend told you this story, what would you say to them?',
  ),
  ReflectionPattern.commit: tr(
    'Ngày mai bạn muốn thử điều gì?',
    'What do you want to try tomorrow?',
  ),
  ReflectionPattern.preserve: tr(
    'Điều gì trong hôm nay đáng được giữ lại?',
    'What from today is worth keeping?',
  ),
};
...
Map<HumanMoment, Map<ReflectionPattern, String>> get _momentPrompts => {
  HumanMoment.arrival: {
    ReflectionPattern.notice: tr(
      'Lúc này trong bạn đang có điều gì?',
      'What is going on inside you right now?',
    ),
    ReflectionPattern.name: tr(
      'Nếu gọi tên cảm giác đó bằng một câu, bạn sẽ nói gì?',
      'If you named that feeling in one line, what would you say?',
    ),
    ReflectionPattern.preserve: tr(
      'Có chi tiết nào của hôm nay bạn muốn nhớ lại sau này?',
      'Is there a detail from today you want to remember later?',
    ),
  },
  HumanMoment.confusion: {
    ReflectionPattern.notice: tr(
      'Điều gì đang khiến bạn thấy chưa ổn?',
      'What is making you feel off?',
    ),
    ReflectionPattern.name: tr(
      'Nếu phải gọi tên điều chưa ổn đó, bạn gọi là gì?',
      'If you had to name what feels off, what would you call it?',
    ),
    ReflectionPattern.explore: tr(
      'Chuyện này làm bạn nhớ tới lần nào trước đây không?',
      'Does this remind you of another time?',
    ),
    ReflectionPattern.preserve: tr(
      'Chi tiết nào trong chuyện này bạn muốn nhớ lại sau?',
      'Which detail of this do you want to remember later?',
    ),
  },
  HumanMoment.decision: {
    ReflectionPattern.notice: tr(
      'Bạn đang phải chọn giữa những điều gì?',
      'What are you having to choose between?',
    ),
    ReflectionPattern.name: tr(
      'Điều gì làm lựa chọn này khó với bạn?',
      'What makes this choice hard for you?',
    ),
    ReflectionPattern.explore: tr(
      'Điều gì thực sự quan trọng với bạn ở đây?',
      'What actually matters to you here?',
    ),
    ReflectionPattern.reframe: tr(
      'Ba năm nữa nhìn lại, bạn mong mình đã chọn thế nào?',
      'Looking back in three years, how do you hope you chose?',
    ),
    ReflectionPattern.commit: tr(
      'Tuần này bạn làm được việc nhỏ nào để chọn dễ hơn?',
      'What small thing could you do this week to make the choice easier?',
    ),
  },
  HumanMoment.growth: {
    ReflectionPattern.notice: tr(
      'Bạn muốn mình khá hơn ở điều gì?',
      'What do you want to get better at?',
    ),
    ReflectionPattern.explore: tr(
      'Kể lại một lần bạn làm được điều đó. Chuyện gì đã xảy ra?',
      'Tell me about a time you did it. What happened?',
    ),
    ReflectionPattern.commit: tr(
      'Tuần này, trong tình huống nào bạn có thể thử lại điều đó?',
      'Where this week could you try that again?',
    ),
    ReflectionPattern.preserve: tr(
      'Điều gì trong lần làm được đó bạn muốn nhớ?',
      'What from that time do you want to remember?',
    ),
  },
  HumanMoment.recovery: {
    ReflectionPattern.notice: tr(
      'Điều gì đang làm bạn mất năng lượng?',
      'What is draining you?',
    ),
    ReflectionPattern.explore: tr(
      'Điều gì làm chuyện này nặng hơn mức bình thường?',
      'What makes this heavier than usual?',
    ),
    ReflectionPattern.preserve: tr(
      'Điều gì đã giúp bạn dễ thở hơn, dù chỉ một chút?',
      'What made it easier to breathe, even a little?',
    ),
  },
  HumanMoment.celebration: {
    ReflectionPattern.notice: tr(
      'Bạn vừa làm được điều gì?',
      'What did you just pull off?',
    ),
    ReflectionPattern.name: tr(
      'Điều gì làm bạn thấy điều đó đáng tự hào?',
      'What makes that feel worth being proud of?',
    ),
    ReflectionPattern.preserve: tr(
      'Khoảnh khắc nào trong chuyện đó bạn muốn nhớ lâu?',
      'Which moment in it do you want to remember for a long time?',
    ),
  },
};
