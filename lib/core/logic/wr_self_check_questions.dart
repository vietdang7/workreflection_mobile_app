...
List<WrSelfCheckQuestion> get kSelfCheckQuestions => <WrSelfCheckQuestion>[
  ...
  WrSelfCheckQuestion(
    ...
    text: tr(
      ...
      'Before you start something new, your responsibilities and who you work with are usually made clear.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-02',
    ...
    text: tr(
      ...
      'For work that matters, you have a concrete process and guidance before you begin.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-03',
    ...
    text: tr(
      ...
      'How your team works together is agreed clearly, and everyone involved is kept up to date.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-04',
    ...
    text: tr(
      ...
      'You know what to share through which channel, without getting lost across too many chats or overlapping emails.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-05',
    ...
    text: tr(
      ...
      'When work changes, you are generally not caught off guard or left to find out on your own.',
    ),
  ),
  ...
  WrSelfCheckQuestion(
    ...
    text: tr(
      ...
      'You find your manager consistent between what they say and what they actually do.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-07',
    ...
    text: tr(
      ...
      'The people you work with are consistent between word and action, so you can rely on what they commit to.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-08',
    ...
    text: tr(
      ...
      'You are comfortable voicing a view that differs from the majority, even when it starts an argument.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-09',
    ...
    text: tr(
      ...
      'When you spot a risk or a problem forming, you are willing to say so, even without a solution yet.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-10',
    ...
    text: tr(
      ...
      'When people disagree, your conversations focus on finding a way forward rather than on who is right.',
    ),
  ),
  ...
  WrSelfCheckQuestion(
    ...
    text: tr(
      ...
      'In day-to-day work, you understand how your own work connects to what the team is aiming for.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-12',
    ...
    text: tr(
      ...
      'When goals change, you are told in time and told why, rather than guessing or finding out late.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-13',
    ...
    text: tr(
      ...
      'Your team has a clear, steady rhythm for working together, with regular check-ins and nothing falling out of step.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-14',
    ...
    text: tr(
      ...
      'After each phase or project, your team has proper time set aside to look back at what was done.',
    ),
  ),
  WrSelfCheckQuestion(
    id: 'scq-15',
    ...
    text: tr(
      ...
      'What comes out of looking back turns into concrete actions with someone following through.',
    ),
  ),
];

/// Tính điểm trung bình (1.0–5.0) cho một pillar từ map {questionId → score (1-5)}.
double computePillarScore(SelfCheckPillar pillar, Map<String, int> answers) {
  final questions = kSelfCheckQuestions
      .where((q) => q.pillar == pillar)
      .toList();
