...
dynamic
get _narratives => <SelfCheckPillar, Map<SelfCheckBand, (String, String)>>{
  SelfCheckPillar.s: {
    SelfCheckBand.strong: (
      tr(
        'Bạn đang có đủ sự rõ ràng để tự chủ',
        'You have enough clarity to work on your own terms',
      ),
      tr(
        ...
        'You know how far your remit goes, what done looks like, and where to '
    ...
    SelfCheckBand.adequate: (
      tr(
        ...
        'Clear enough to run, not clear enough to relax',
      ),
      tr(
        ...
        'On a normal day you know what to do. But when priorities shift or work '
    ...
    SelfCheckBand.friction: (
      tr(
        ...
        'The fog is taking a share of your energy',
      ),
      tr(
        ...
        'You are having to work a lot out before you can start: who owns what, '
    ...
    SelfCheckBand.blocked: (
      tr(
        ...
        'You are working without the basic markers to lean on',
      ),
      tr(
        ...
        'Expectations are unspoken, the lines of responsibility are undrawn, '
  ...
  SelfCheckPillar.c: {
    SelfCheckBand.strong: (
      tr(
        ...
        'You are somewhere safe enough to be yourself',
      ),
      tr(
        ...
        'You can trust the people you work with, say what you mean without '
    ...
    SelfCheckBand.adequate: (
      tr(
        ...
        'Relationships hold when things are easy, less so under strain',
      ),
      tr(
        'Ở nhịp bình thường mọi thứ diễn ra dễ chịu. Nhưng khi có áp lực, sai sót '
            ...
            'không được nói ra.',
        'At a normal pace everything is pleasant. But under pressure, after a '
    ...
    SelfCheckBand.friction: (
      tr(
        ...
        'You are holding back more than you should have to',
      ),
      tr(
        ...
        'You weigh things before speaking, avoid certain conversations, and are '
    ...
    SelfCheckBand.blocked: (
      tr(
        ...
        'The psychological cost you are paying is high',
      ),
      tr(
        ...
        'Trust is low, honesty carries risk, and tension simmers with no way '
  ...
  SelfCheckPillar.a: {
    SelfCheckBand.strong: (
      tr(
        ...
        'The way you work is genuinely moving you forward',
      ),
      tr(
        ...
        'You can see how your work connects to something larger, the rhythm is '
    ...
    SelfCheckBand.adequate: (
      ...
      tr(
        ...
        'Some of the time you work deeply and some of the time you are swept '
    ...
    SelfCheckBand.friction: (
      tr(
        ...
        'You are busier than you are progressing',
      ),
      tr(
        ...
        'Work gets interrupted often, important loses to urgent, and you rarely '
    ...
    SelfCheckBand.blocked: (
      tr(
        ...
        'You are running with nothing holding the direction',
      ),
      tr(
        ...
        'Goals are unclear or keep changing, the working rhythm lacks '
...
String imbalanceNarrative(PillarImbalance key) => switch (key) {
  PillarImbalance.allLow => tr(
    ...
    'All three sides are low at once. When everything is hard it is very '
  ...
  PillarImbalance.sNotablyLow => tr(
    ...
    'Your relationships and ways of working are clearly better than your '
  ...
  PillarImbalance.cNotablyLow => tr(
    ...
    'You know what you need to do and you can do it, but in a place where '
  ...
  PillarImbalance.aNotablyLow => tr(
    ...
    'Clarity and relationships are clearly better than the way you work. '
  ...
  PillarImbalance.aHighScLow => tr(
    ...
    'You are keeping up a working rhythm and a capacity to learn well '
  ...
  PillarImbalance.cHighSLow => tr(
    ...
    'Relationships in the team are better than the clarity about the work. '
  ...
  PillarImbalance.sHighCLow => tr(
    ...
    'The work is organised far better than the relationships. The process '
...
class SelfCheckTrend {
  ...
  String get summary {
    ...
    if (d.abs() < 0.15) {
      return tr(
        'So với lần trước, bức tranh của bạn gần như không đổi. Điều đó '
            'không xấu, nó cho thấy những gì bạn đang gặp là điều kiện ổn định '
            'chứ không phải một tuần tồi tệ.',
        'Compared with last time, your picture is almost unchanged. That '
