...
List<WrJdDay> get kJdDays => [
  WrJdDay(
    ...
    intro: tr(
      'Đừng áp lực phải viết đúng chuẩn. Hãy thoải mái trả lời những câu '
          'hỏi, chia sẻ của bạn sẽ là chất liệu để tạo nên bản JD hoàn chỉnh.',
      'No pressure to get the wording right. Just answer freely; what you '
    ...
    fields: [
      WrJdField(
        ...
        label: tr(
          'Việc gì bạn lặp đi lặp lại mỗi ngày, mỗi tuần?',
          'What do you do over and over, every day or every week?',
        ),
        hint: tr(
          'Ví dụ: Sáng nào cũng kiểm tra đơn hàng mới, gọi xác nhận với '
              'khách...',
          'For example: Check new orders every morning, call customers to '
              'confirm...',
        ),
      ),
      WrJdField(
        ...
        label: tr(
          'Nếu bạn nghỉ phép một tuần, việc gì sẽ bị ùn lại vì không ai '
              'làm thay?',
          'If you took a week off, what would pile up because nobody else '
              'could do it?',
        ),
        hint: tr(
          'Ví dụ: Không ai xử lý được khiếu nại của khách vì chỉ mình mình '
              'biết quy trình...',
          'For example: Nobody could handle customer complaints because only '
              'I know the process...',
        ),
      ),
      WrJdField(
        ...
        label: tr(
          'Đồng nghiệp hoặc sếp thường nhờ/hỏi bạn về việc gì nhất?',
          'What do colleagues or your manager come to you for most?',
        ),
        hint: tr(
          'Ví dụ: Sếp hay hỏi mình về tình trạng đơn hàng trễ...',
          'For example: My manager always asks me about late orders...',
        ),
      ),
    ],
  ),
  WrJdDay(
    ...
    fields: [
      WrJdField(
        ...
        hint: tr(
          'VD: Nhân viên Chăm sóc khách hàng',
          'e.g. Customer Care Officer',
        ),
      ...
      WrJdField(
        ...
        hint: tr(
          'VD: Nhân viên chính thức, 2 năm kinh nghiệm',
          'e.g. Permanent staff, 2 years of experience',
        ),
        kind: WrJdFieldKind.line,
      ),
      WrJdField(
        ...
        hint: tr(
          'Viết mục tiêu công việc của bạn...',
          'Write the purpose of your role...',
        ),
        guide: tr(
          'Cách viết: Tóm tắt 1-2 câu. Trả lời: "Nếu vị trí này không tồn '
              'tại, công ty sẽ thiếu điều gì?"',
          'How to write it: One or two sentences. Answer: "If this role did '
              'not exist, what would the company be missing?"',
        ),
        example: tr(
          'Đảm bảo đơn hàng của khách được xử lý chính xác, đúng hạn.',
          'Make sure customer orders are handled accurately and on time.',
        ),
      ),
    ],
  ),
  WrJdDay(
    ...
    fields: [
      WrJdField(
        column: 'main_tasks',
        label: tr(
          'Những nhiệm vụ chính bạn đang làm là gì?',
          'What are the main things you do?',
        ),
        hint: tr(
          'Liệt kê nhiệm vụ chính, mỗi dòng một việc...',
          'List your main duties, one per line...',
        ),
  ...
  WrJdDay(
    ...
    fields: [
      WrJdField(
        column: 'outcomes',
        label: tr(
          'Kết quả cụ thể công việc của bạn tạo ra là gì?',
          'What concrete results does your work produce?',
        ),
        hint: tr(
          'Viết kết quả và chỉ số công việc của bạn...',
          'Write your results and the numbers behind them...',
        ),
        guide: tr(
          'Cách viết: Càng có số liệu càng tốt. Nếu công ty chưa giao KPI '
              'chính thức, hãy tự ước lượng dựa trên thực tế.',
          'How to write it: Numbers help. If the company has not set formal '
              'KPIs, estimate from what actually happens.',
        ),
        example: tr(
          'Xử lý trung bình 40 đơn/ngày, tỷ lệ giao đúng hạn từ 95% trở '
              'lên.',
          'Handle around 40 orders a day, with on-time delivery at 95% or '
              'better.',
        ),
      ),
      WrJdField(
        column: 'skills',
        label: tr(
          'Kiến thức, kỹ năng và công cụ bạn dùng?',
          'What knowledge, skills and tools do you use?',
        ),
        hint: tr(
          'Viết kỹ năng và công cụ bạn đang sử dụng...',
          'Write the skills and tools you actually use...',
        ),
        guide: tr(
          'Cách viết: Chia thành kỹ năng chuyên môn, kỹ năng mềm, và phần '
              'mềm/công cụ đang dùng thực tế.',
          'How to write it: Split it into technical skills, people skills, '
  ...
  WrJdDay(
    ...
    fields: [
      WrJdField(
        ...
        label: tr(
          'Bạn phối hợp với ai trong công việc?',
          'Who do you work with?',
        ),
        hint: tr(
          'Viết những phòng ban, đồng nghiệp hoặc đối tác bạn thường làm '
              'việc cùng...',
          'Write the teams, colleagues or partners you usually work '
              'with...',
        ),
        example: tr(
          'Phối hợp thường xuyên với phòng Kho vận, Kế toán; làm việc '
              'trực tiếp với khách qua điện thoại.',
          'Work closely with Warehouse and Accounting; deal with customers '
              'directly by phone.',
        ),
      ),
      WrJdField(
        ...
        label: tr(
          'Điều kiện làm việc của bạn ra sao?',
          'What are your working conditions?',
        ),
        hint: tr(
          'Viết giờ làm việc, địa điểm, yêu cầu đặc thù nếu có...',
          'Write your hours, location, and any particular requirements...',
        ),
        example: tr(
          'Làm giờ hành chính tại văn phòng, thỉnh thoảng tăng ca cuối '
              'tháng để chốt báo cáo.',
          'Office hours at the office, with occasional overtime at month '
...
bool isJdComplete(List<int> completedDays) =>
    List.generate(kJdDayCount, (i) => i + 1).every(completedDays.contains);
