...
String get kGuideChatSubtitle =>
    tr('Hỗ trợ bạn mọi lúc', 'Here whenever you need it');
...
String get kGuideClosingCta => tr(
  'Bạn cần hỗ trợ thêm? Hỏi Trợ lý AI.',
...
List<WrGuideSection> wrGuideSections() => [
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Một hai phút mỗi ngày, không phải app ghi chú',
    ...
    blocks: [
      WrGuideText(
        tr(
          'WorkReflection không đơn thuần là một ứng dụng ghi chú.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Chạm một cái là xong bước đầu',
      'One tap and the first step is done',
    ),
    blocks: [
      WrGuideSteps([
        WrGuideStep(
          ...
          tr(
            'Đây là cách nhanh nhất để bắt đầu, chỉ cần một lần chạm.',
            'This is the quickest way in: it takes one tap.',
          ),
        ),
        WrGuideStep(
          tr(
            'Đi qua bốn bước nhìn lại.',
            'Go through the four look-back steps.',
          ),
          tr(
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Nơi bạn bắt đầu mỗi ngày, chỉ với một lần chạm.',
    ...
    blocks: [
      ...
      WrGuideSteps([
        ...
        WrGuideStep(
          ...
          tr(
            'Một vài gợi ý hành động nhỏ, phù hợp với điều bạn vừa nhận ra.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Nhận diện những mẫu hình đang lặp lại trong công việc của bạn.',
      'Spot the patterns repeating in your work.',
    ),
    blocks: [
      WrGuideHeading(
        tr(
          '${kSelfCheckQuestions.length} câu hỏi phản chiếu (Self-Check)',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Lưu giữ Career Memory và theo dõi tiến trình qua thời gian.',
    ...
    blocks: [
      ...
      WrGuideBullets([
        WrGuideBullet(
          ...
          tr(
            'Mỗi lần bạn hoàn thành một lượt nhìn lại.',
        ...
        WrGuideBullet(
          ...
          tr(
            'Những lần đầu tiên đáng nhớ, ví dụ lần đầu bạn hoàn thành Self-Check.',
        ...
        WrGuideBullet(
          tr('Insight.', 'Insights.'),
          tr(
            'Nhận định tổng hợp từ nhiều lần nhìn lại gần nhau. Dành cho gói Premium.',
      ...
      WrGuideText(
        tr(
          'Bấm vào một mục bất kỳ để xem thêm chi tiết.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Để gợi ý bám sát công việc thật của bạn hơn.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Quản lý thông tin cá nhân, dữ liệu và gói dịch vụ.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Những gì được mở thêm so với gói miễn phí.',
    ...
    blocks: [
      WrGuideChecks(
        [
          tr(
            'Diễn giải sâu và theo dõi xu hướng cho Self-Check.',
            'A deeper reading and trend tracking for your Self-Check.',
          ),
          tr(
            'AI Insight cá nhân hóa trong Career Memory.',
            'Personalised AI insights in your Career Memory.',
          ),
          tr(
            'Xem toàn bộ Career Memory, không giới hạn số ghi nhận.',
            'See your whole Career Memory, with no limit on entries.',
          ),
          tr(
            'Không giới hạn số chủ đề thực hành cùng lúc.',
            'No limit on how many practice themes you run at once.',
          ),
          tr(
            'Góc nhìn phát triển, tổng hợp từ toàn bộ hành trình của bạn.',
            'A development view drawn from your whole journey.',
          ),
        ],
        // Không có giá, không có nút mua — xem ghi chú đầu file.
        footnote: tr(
          'Bạn có thể xem chi tiết và nâng cấp bất cứ lúc nào từ trang Hồ sơ.',
  ...
  WrGuideSection(
    ...
    summary: tr(
      'Các câu hỏi phổ biến về quyền riêng tư và cách dùng.',
    ...
    blocks: [
      WrGuideQa([
        WrGuideQaItem(
          tr(
            'Tôi có bắt buộc nhìn lại mỗi ngày không?',
        ...
        WrGuideQaItem(
          tr(
            'Những gì tôi viết có ai khác đọc được không?',
        ...
        WrGuideQaItem(
          tr(
            'Tôi bỏ trống phần viết thì có sao không?',
        ...
        WrGuideQaItem(
          ...
          tr(
            'Có. Bạn quản lý hoặc hủy gói Premium từ trang Hồ sơ.',
            'Yes. You manage or cancel Premium from your Profile.',
          ),
        ),
        WrGuideQaItem(
          tr(
            'Công ty tôi đã có JD rồi thì sao?',
            'What if my company already has a JD?',
          ),
          tr(
            'Bạn tải lên file JD hoặc CV sẵn có, không cần viết mới cùng ứng dụng.',
