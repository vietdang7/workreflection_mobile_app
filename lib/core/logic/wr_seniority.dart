...
Map<String, Map<SeniorityTier, String>> get kTransformByTier => {
  'pt-s1': {
    SeniorityTier.individual: tr(
      'Với mọi việc mới, luôn làm rõ kết quả tốt trông như thế nào trước khi '
          'bắt đầu.',
      'For anything new, make clear what a good outcome looks like before you '
          'start.',
    ),
    SeniorityTier.leadTeam: tr(
      'Đặt rõ kỳ vọng cho từng người trong nhóm, không giả định họ tự hiểu '
          'như bạn.',
      'Set expectations for each person on the team; do not assume they read '
          'it the way you do.',
    ),
    SeniorityTier.leadOrg: tr(
      'Giữ kỳ vọng nhất quán giữa các nhóm, để không ai nhận hai tiêu chuẩn '
          'khác nhau cho cùng một việc.',
      'Keep expectations consistent across teams, so nobody gets two different '
  ...
  'pt-s2': {
    SeniorityTier.individual: tr(
      'Xây một cách phân loại việc theo mức độ bạn thực sự cần quyết định, '
          'dùng lại mỗi tuần.',
      'Build a way of sorting work by how much you genuinely need to decide, '
          'and reuse it weekly.',
    ),
    SeniorityTier.leadTeam: tr(
      'Giúp từng người trong nhóm tự phân biệt việc quan trọng và việc gấp, '
          'không quyết định thay họ mọi lúc.',
      'Help each person tell important from urgent themselves, rather than '
    ...
    SeniorityTier.leadOrg: tr(
      ...
      'Allocate priority across teams from shared goals, not from whoever is '
          'loudest.',
    ),
  },
  'pt-s3': {
    SeniorityTier.individual: tr(
      'Xây thói quen xác nhận lại thông tin quan trọng trước khi hành động '
          'theo đó.',
      'Make it a habit to confirm important information before acting on it.',
    ),
    SeniorityTier.leadTeam: tr(
      'Chủ động truyền đạt lý do đằng sau một thay đổi cho nhóm, trước khi họ '
          'phải tự đoán.',
      'Tell the team the reasoning behind a change before they have to guess '
          'at it.',
    ),
    SeniorityTier.leadOrg: tr(
      'Dẫn dắt nhiều nhóm qua một thay đổi lớn, giữ thông tin nhất quán ở mọi '
          'cấp truyền đạt.',
      'Lead several teams through a large change, keeping the message '
  ...
  'pt-c1': {
    SeniorityTier.individual: tr(
      ...
      'Hand work over whole, without managing the detail, as a habit rather '
          'than an exception.',
    ),
    SeniorityTier.leadTeam: tr(
      'Học cách giao việc và thật sự buông, thay vì giao rồi vẫn kiểm tra như '
          'chưa từng giao.',
      'Learn to delegate and actually let go, instead of handing over and '
    ...
    SeniorityTier.leadOrg: tr(
      ...
      'Build a culture of trust applied consistently across teams, not just '
  ...
  'pt-c2': {
    SeniorityTier.individual: tr(
      'Chủ động chia sẻ một góc nhìn của riêng bạn, không chỉ trả lời khi '
          'được hỏi.',
      'Offer a view of your own, rather than only answering when asked.',
    ),
    SeniorityTier.leadTeam: tr(
      'Tạo một khoảng an toàn rõ ràng để từng người trong nhóm dám nói, không '
          'chỉ chờ họ tự dũng cảm.',
      'Create clear room for each person to speak up, rather than waiting for '
    ...
    SeniorityTier.leadOrg: tr(
      ...
      'Make sure voices from the teams below genuinely reach where decisions '
  ...
  'pt-c3': {
    SeniorityTier.individual: tr(
      'Đưa phản hồi trở thành nhịp thường xuyên trong đội, không chỉ khi có '
          'vấn đề.',
      'Make feedback a regular rhythm in the team, not something that only '
          'appears when there is a problem.',
    ),
    SeniorityTier.leadTeam: tr(
      'Đưa phản hồi đều đặn cho từng người, không dồn lại đến kỳ đánh giá mới '
          'nói.',
      'Give each person feedback steadily, rather than saving it all for '
          'review season.',
    ),
    SeniorityTier.leadOrg: tr(
      'Xây một quy trình phản hồi hai chiều cho toàn bộ phạm vi phụ trách, '
          'không chỉ từ trên xuống.',
      'Build a two-way feedback process across everything you cover, not just '
          'top-down.',
    ),
  },
  'pt-a1': {
    SeniorityTier.individual: tr(
      'Đặt một nhịp định kỳ để tự hỏi lại mục tiêu, thay vì làm theo quán '
          'tính.',
      'Set a regular rhythm for questioning the goal, instead of running on '
          'momentum.',
    ),
    SeniorityTier.leadTeam: tr(
      'Kết nối mục tiêu của từng người trong nhóm với mục tiêu chung, để không '
          'ai chỉ làm vì được giao.',
      'Connect each person\'s goals to the shared one, so nobody is working '
    ...
    SeniorityTier.leadOrg: tr(
      ...
      'Keep strategic direction clear and consistent, so teams do not drift '
          'apart over time.',
    ),
  },
  'pt-a2': {
    SeniorityTier.individual: tr(
      ...
      'Set a fixed rhythm of rest, rather than waiting until you are spent.',
    ),
    SeniorityTier.leadTeam: tr(
      'Chủ động bảo vệ nhịp làm việc của nhóm, không để deadline gấp trở thành '
          'trạng thái bình thường.',
      'Protect the team\'s working rhythm, so rushed deadlines do not become '
          'the normal state.',
    ),
    SeniorityTier.leadOrg: tr(
      'Xây văn hóa làm việc bền vững ở quy mô rộng, để kiệt sức không trở '
          'thành cái giá ngầm định của hiệu suất.',
      'Build sustainable ways of working at scale, so burnout is not the '
  ...
  'pt-a3': {
    SeniorityTier.individual: tr(
      ...
      'Learn to catch the signs of a reaction early, before it is already said.',
    ),
    SeniorityTier.leadTeam: tr(
      'Giữ bình tĩnh khi cả nhóm đang căng thẳng, vì phản ứng của bạn lúc đó '
          'ảnh hưởng đến tất cả.',
      'Stay steady when the team is under strain, because how you react then '
          'lands on everyone.',
    ),
    SeniorityTier.leadOrg: tr(
      'Ra quyết định bình tĩnh ở những tình huống có phạm vi ảnh hưởng lớn, '
          'khi áp lực dồn về một người.',
      'Decide calmly in situations with wide consequences, when the pressure '
          'lands on one person.',
    ),
  },
  'pt-a4': {
    SeniorityTier.individual: tr(
      'Đặt một nhịp nhìn lại định kỳ (retro cá nhân), để việc học không chỉ là '
          'tình cờ.',
      'Set a regular look-back rhythm for yourself, so learning is not just '
          'accidental.',
    ),
    SeniorityTier.leadTeam: tr(
      'Xây một nhịp nhìn lại định kỳ cho cả nhóm, để bài học không chỉ nằm lại '
          'ở một người.',
      'Build a regular look-back rhythm for the team, so the lesson does not '
    ...
    SeniorityTier.leadOrg: tr(
      ...
      'Build a way of capturing and sharing lessons across everything you '
